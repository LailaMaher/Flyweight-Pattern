	...
	public Word(){
		...
		button.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent event) {
				...
				Glyph[] glyphs = new Glyph[NUMBER_OF_LETTERS];
				
				for(int i = 0; i < NUMBER_OF_LETTERS; ++i){
					glyphs[i] = new Letter(getRandomChar(), getRandomFont(), getRandomX(), getRandomY());	
				}
				...
				System.out.println(duration + " milliseconds to execute draw method");
